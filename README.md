...
## Compressing image using K-Means

```
python newKmeans.py --image <image_file> -k <list of value of k>

```
Compress the file with different quality as given by user as value of k

## Compressing image using the Map

    ```
    python newcombine_images.py -image <image_file> -map <map_file>
    ```
