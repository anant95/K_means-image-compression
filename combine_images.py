...
def make_quality_compression(original,sal):
    ...
    original.save(compressed, quality = 100)
    ...
    out_img.save(out_name, quality = 100)
    compressed_size = os.path.getsize(out_name)
    k_means_50_size = os.path.getsize("temp_xxx_zzz/temp_50.jpg")
    
    print(out_name, compressed_size)
    print(compressed, original_size)
    print("temp_50.jpg", k_means_50_size)
